...
locals {
  ...
  # var.image debe venir como "repo:tag" (p.ej. "clasificador-api:latest")
  container_image  = "${data.aws_caller_identity.current.account_id}.dkr.ecr.${var.region}.amazonaws.com/clasificador-api:latest"
